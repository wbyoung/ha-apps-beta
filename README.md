...
**Warning**: _This repository contains beta builds. They may not have been
tested as well as the stable versions._
...
```txt
https://github.com/wbyoung/ha-apps-beta
```
...
[addon-external_logs]: https://github.com/wbyoung/ha-external-logs/tree/1.0.2b1
[addon-doc-external_logs]: https://github.com/wbyoung/ha-external-logs/blob/1.0.2b1/README.md
[external_logs-issue]: https://github.com/wbyoung/ha-external-logs/issues
[external_logs-version-shield]: https://img.shields.io/badge/version-1.0.2b1-blue.svg
...
[supervisor-add-link]: https://my.home-assistant.io/redirect/supervisor_add_addon_repository/?repository_url=https%3A%2F%2Fgithub.com%2Fwbyoung%2Fha-apps-beta[license-shield]: https://img.shields.io/github/license/wbyoung/ha-apps-beta.svg
