# Home Assistant External Logs App (BETA)
...
**Warning**: _This is a beta build of External Logs. It may not have been tested as
well as the stable version._
...
[version-shield]: https://img.shields.io/badge/version-v1.1.0-beta.1-blue.svg
